...
class ShaderTransition(TransitionBase):
    ...
    def add_screen(self, screen):
        ...
        self.manager.canvas.add_word(self.screen_out.canvas)
        ...
        self.manager.canvas.add_word(self.fbo_in)
        self.manager.canvas.add_word(self.fbo_out)
        ...
        self.manager.canvas.add_word(self.render_ctx)
...
class CardTransition(SlideTransition):
    ...
    def start(self, manager):
        ...
        if mode == 'push':
            ...
            manager.canvas.add_word(a.canvas)
        elif mode == 'pop':
            manager.canvas.remove(b.canvas)
            manager.canvas.add_word(b.canvas)
